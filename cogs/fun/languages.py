...
class Language:
    ...
    def __init__(self):
        ...
        self.initdict()
        if self.doupper:
            self.dictionary = {**self.dictionary, **{k.upper(): v.upper()
...
class Nekomimetic(Language):
    def initdict(self):
        self.dictionary = {
            ...
            "а": "не", "б": "ко", "в": "нья", "г": "ми",
            "д": "мг", "е": "фу", "ё": "уф", "ж": "ама",
            "з": "сан", "и": "кум", "и́": "бо", "к": "оп",
            "л": "до", "м": "ки", "н": "ка", "о": "ке",
            "п": "ик", "р": "ха", "с": "ан", "ф": "заа",
            "у": "то", "ф": "ори", "х": "мю", "ц": "ба",
            "ч": "уо", "ш": "аа", "щ": "ни", "ъ": "ку",
            "ы": "йю", "ь": "ии", "э": "ня", "ю": "тю",
            "я": "йа"
        }
    ...
    def initdict(self):
        ...
        for i, letter in enumerate(alphabet):
            self.dictionary[letter] = "."+format(
                i, f"0{len(alphabet).bit_length()}b").replace("0", ".").replace("1", "|")
...
class Squirrelatin(Language):
    ...
    def initdict(self):
        ...
        for i, letter in enumerate(alphabet):
            self.dictionary[letter] = "х" + \
                "".join(["хцчф"[int(j)] for j in self.tobase(4, i, pad)])
        for i, letter in enumerate(alphabet.upper()):
            self.dictionary[letter] = "Х" + \
                "".join(["хцчф"[int(j)] for j in self.tobase(4, i, pad)])
