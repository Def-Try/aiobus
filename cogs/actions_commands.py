...
class actions_commands(commands.Cog):
    ...
    acts_1 = discord.SlashCommandGroup("actions_1",
                                       name_localizations=localise(
                                           "cog.actions_commands.command_group.name"),
    ...
    async def act(self, action: str, ctx: discord.ApplicationContext):
        ...
        embed = discord.Embed(
            title=localise(
                f"cog.actions_commands.answers.action.name", locale),
    ...
    async def act_req_other(self, action: str, ctx: discord.ApplicationContext, other: discord.Option(discord.Member,
                                                                                                      ...
                                                                                                      description=localise(
                                                                                                          "cog.actions_commands.commands.action.options.other.desc", DEFAULT_LOCALE),
        ...
        localis_act_other = localise(
            f"cog.actions_commands.answers.action.{action}.other", ctx.interaction.locale)
        embed = discord.Embed(
            title=localise(
                f"cog.actions_commands.answers.action.name", locale),
    ...
    async def act_with_other(self, action: str, ctx: discord.ApplicationContext, other: discord.Option(discord.Member,
        ...
        embed = discord.Embed(
            ...
            localis_act_other.format(
                member=ctx.author.mention, other=other.mention)
            if other else
            localis_act_none.format(member=ctx.author.mention),
            color=discord.Colour.blurple(),
        )
        embed.set_image(url=result.url)
        await ctx.respond(embed=embed)
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.pat"),
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.hug"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.cuddle"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.handshake"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.bite"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.highfive"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.kiss"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.poke"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.slap"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.handhold"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.kick"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.punch"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.tickle"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.feed"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.stare"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.wave"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.cry"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.dance"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.blush"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.happy"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.laugh"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.shrug"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.sleep"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.smile"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_1.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.think"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_2.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.nod"),
                    description_localizations=localise("cog.actions_commands.commands.action.desc"))
    ...
    @acts_2.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.portal.name"),
    ...
    async def portal(self, ctx: discord.ApplicationContext):
        if ctx.author.id in portals_awaiting.keys():
            ...
            embed = discord.Embed(
                title=localise(
                    "cog.actions_commands.answers.action.portal.opening.title", ctx.interaction.locale),
                description=localise("cog.actions_commands.answers.action.portal.opening.from", ctx.interaction.locale).format(
                    member=ctx.author.mention, channel=ctx.channel.mention),
                color=discord.Colour.blurple(),
            )
            ...
            embed = discord.Embed(
                title=localise(
                    "cog.actions_commands.answers.action.portal.opening.title", ctx.interaction.locale),
                description=localise("cog.actions_commands.answers.action.portal.opening.to", ctx.interaction.locale).format(
                    channel=portals_awaiting[ctx.author.id].channel.mention),
                color=discord.Colour.blurple(),
            )
            await ctx.send(embed=embed)

            del portals_awaiting[ctx.author.id]
            await ctx.respond(localise("cog.actions_commands.answers.action.portal.step2", ctx.interaction.locale), ephemeral=True)
            return
    ...
    @acts_2.command(guild_ids=CONFIG["g_ids"],
                    name_localizations=localise(
                        "cog.actions_commands.commands.portal_cancel.name"),
    ...
    async def portal_cancel(self, ctx: discord.ApplicationContext):
        del portals_awaiting[ctx.author.id]
        await ctx.respond(localise("cog.actions_commands.answers.action.cancel_portal", ctx.interaction.locale), ephemeral=True)
